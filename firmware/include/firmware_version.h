...
#ifndef VENDOR_NAME
  #define VENDOR_NAME "LOBO-IoT"
#endif
#ifndef MODEL_NAME
  #define MODEL_NAME  "SupervisorCargas_TX"
#endif

// Cadena formateada para impresión, p. ej.: "v1.0.0 (HW1) 2025-10-24"
#define FW_VERSION_STR  "v" STR(FW_VERSION_GLOBAL) "." STR(FW_VERSION_MINOR) "." STR(FW_VERSION_PATCH) " (HW" STR(HW_REV) ") " FW_BUILD_DATE
...
#define FW_SEMVER_U32  ((uint32_t)((FW_VERSION_GLOBAL & 0xFF) << 16) | ((FW_VERSION_MINOR & 0xFF) << 8) | (FW_VERSION_PATCH & 0xFF))
